...
/*
--------------------------------------------
Code edited by Agnaldo Batista - UFPR and João Monteiro Delveaux Silva - UFMG <joaomont@ufmg.br>
--------------------------------------------
*/
...
{	
	...
	for(auto n :m_neighInfosVector){
		...
		nInfos[j].z = n.z; 
		nInfos[j].hop = n.hop;
		nInfos[j].infoTime = m_messageTime;
		j+=1;
	}
...
void MyTag::Deserialize (TagBuffer i)
{
	...
	m_nNeighborsValue = i.ReadU32(); // Extract the number of neighbors value
