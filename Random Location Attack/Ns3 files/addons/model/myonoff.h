...
*/
class MyOnOff : public Application 
{
public:
  /**
  ...
  */
  ...
  // Custom Functions by Joao Monteiro D. Silva
    ...
    void Setup (Address address, uint32_t protocolId, unsigned seed);
...
private:
  ...
  // Custom attributes by Joao Monteiro D. Silva
    ...
    Address         m_node;       //!< Associated node Address
    Ipv4Address     m_nodeIP;       //!< Associated node IPv4Address
    bool            m_oprStarted;       //!< Indicates if it is the first time the aplication sends data 
