...
private:
  ...
  // Custom Callbacks by Joao Monteiro D. Silva
    ...
    TracedCallback<const Ipv4Address &, const Ipv4Address &, const Ipv4Address &, MyTag &, const double &, const Ptr <ns3::Node>& > m_myRxTrace;
    /// Traced Callback: received packets.
    ...
    /// Traced Callback: transmitted malicious packets.
  ...
  // Custom Functions by Joao Monteiro D. Silva
    ...
    void notifyAboutMaliciousNeighbor (Ipv4Address ip, uint8_t tagType);
