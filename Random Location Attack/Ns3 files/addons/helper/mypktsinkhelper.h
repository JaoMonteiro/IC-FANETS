 ...
 */
#ifndef MYPKTSINKHELPER_H
#define MYPKTSINKHELPER_H

#include "ns3/object-factory.h"
#include "ns3/ipv4-address.h"
#include "ns3/node-container.h"
#include "ns3/application-container.h"
#include "ns3/mypktsink.h"
 ...
 * on a set of nodes.
 */
class MyPktSinkHelper
{
public:
  /**
   * Create a MyPktSinkHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  MyPktSinkHelper (std::string protocol, Address address);
