...
class Statistics {
  public: 
    ...
    void suspiciousActivityCallback (const Ptr <Node>&m_node, const Ipv4Address &sender, const double &time, const double &latency, const int &status, const bool &blocked);  
